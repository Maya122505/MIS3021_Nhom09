...
public class GeneralPage {
    ...
    // Locators
    private final By tabLogin = By.xpath("//div[@id='menu']//a[span[normalize-space()='Login']]");
    private final By tabLogout = By.xpath("//div[@id='menu']//a[span[normalize-space()='Log out']]");
    private final By lblWelcomeMessage = By.xpath("//div[@class='account']/strong");
    private final By tabMyTicket = By.xpath("//div[@id='menu']//a[span[normalize-space()='My ticket']]");
    private final By tabChangePassword = By.xpath("//div[@id='menu']//a[span[normalize-space()='Change password']]");
    private final By tabRegister = By.xpath("//div[@id='menu']//a[span[normalize-space()='Register']]");
    private final By tabBookTicket = By.xpath("//div[@id='menu']//a[span[normalize-space()='Book ticket']]");
    private final By tabSchedule = By.xpath("//div[@id='menu']//a[span[normalize-space()='Timetable']]");
